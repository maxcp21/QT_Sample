 ...
 : QWidget(parent)
{
        ...
        srcCodec = QTextCodec::codecForName("BIG5");
...
void ConvertWidget::on_btnConvert_clicked()
{
        ...
        QDirIterator it(txtSource->text(), QDirIterator::Subdirectories);
         ...
         QMessageBox::information(this, tr("提示"), tr("轉換完畢!"));
}
...
{
         QString dir = QFileDialog::getExistingDirectory(this, tr("選擇來源目錄"),
                                                         txtSource->text(),
...
{
         QString dir = QFileDialog::getExistingDirectory(this, tr("選擇目的目錄"),
                                                         txtDest->text(),
                                                         QFileDialog::ShowDirsOnly
                                                         | QFileDialog::DontResolveSymlinks);
         txtDest->setText(dir);
...
void ConvertWidget::on_radioUTFToGB_clicked()
{
        ...
        destCodec = QTextCodec::codecForName("BIG5");
}
